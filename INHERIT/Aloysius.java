public class Aloysius extends CollegeDetails{
	
	int numberOfFestivals;
	

	public Aloysius(HeadOfDepartment[] hod, Principal principal, Students[] student, Professors[] professors, int numberOfFestivals){
	...
	public void printDetails(){
		...
		System.out.println("\n_________ALOYSIUS COLLEGE DETAILS_________");
